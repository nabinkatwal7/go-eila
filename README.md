...
```bash
go build -ldflags="-s -w" -o mytrack cmd/mytrack/main.go
```
...
- **[User Guide](docs/USER_GUIDE.md)** - Detailed usage instructions for end users
- **[API Documentation](docs/API.md)** - Complete API reference for the repository layer
